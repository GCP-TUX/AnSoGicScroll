...
namespace {
struct qt_meta_tag_ZN17ScreenshotManagerE_t {};
} // unnamed namespace

template <> constexpr inline auto ScreenshotManager::qt_create_metaobjectdata<qt_meta_tag_ZN17ScreenshotManagerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ScreenshotManager, qt_meta_tag_ZN17ScreenshotManagerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ScreenshotManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17ScreenshotManagerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17ScreenshotManagerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN17ScreenshotManagerE_t>.metaTypes,
    nullptr
} };
...
void *ScreenshotManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17ScreenshotManagerE_t>.strings))
