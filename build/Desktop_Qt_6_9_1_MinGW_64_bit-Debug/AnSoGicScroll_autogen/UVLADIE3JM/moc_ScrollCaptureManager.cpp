...
namespace {
struct qt_meta_tag_ZN20ScrollCaptureManagerE_t {};
} // unnamed namespace

template <> constexpr inline auto ScrollCaptureManager::qt_create_metaobjectdata<qt_meta_tag_ZN20ScrollCaptureManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSelectionCancelled'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onCaptureNextRequested'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onFinishRequested'
    ...
    return QtMocHelpers::metaObjectData<ScrollCaptureManager, qt_meta_tag_ZN20ScrollCaptureManagerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ScrollCaptureManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20ScrollCaptureManagerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20ScrollCaptureManagerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN20ScrollCaptureManagerE_t>.metaTypes,
    nullptr
} };
...
void *ScrollCaptureManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20ScrollCaptureManagerE_t>.strings))
